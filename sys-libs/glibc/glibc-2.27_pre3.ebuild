...
if [[ ${PV} == 9999* ]]; then
	...
	KEYWORDS="riscv"
	SRC_URI="mirror://gnu/glibc/glibc-2.26.tar.xz"
fi

RELEASE_VER=${PV}

GCC_BOOTSTRAP_VER="7.2.0"

IUSE="audit caps debug gd hardened headers-only multilib nscd selinux systemtap profile suid vanilla"

S="${WORKDIR}/glibc-2.26"
